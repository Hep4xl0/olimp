...
function Season() {
    ...
    return (
        <MainBox>
            <MomentumBox>
                <ButtonFlame flameActive={flameActive} snowflakeActive={snowflakeActive} onClick={handleFlameClick}><MomentumImg src={flame} />        
                </ButtonFlame>
                <h2>{season}</h2>
            ...
            <Score>
                ...
                <TopDescription>
                    ...
                    {isActive && (
                        <Drawer style={{ marginTop: '10px', border: '1px solid #ccc', padding: '10px', borderRadius: '5px' }}>
                            <Description>Athlete</Description>
                            <IconMedals style={{ display: 'flex' }}>
